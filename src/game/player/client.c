	   	...
	   	edict_t *attacker)
{
	...
	if (deathmatch->value || coop->value)
	{
		...
		{
			case MOD_SUICIDE:
				message = "did a stuipid thing";
				break;
			case MOD_FALLING:
				message = "fell to his misery";
				break;
			case MOD_CRUSH:
				message = "crushed lol";
				break;
			case MOD_WATER:
				message = "got rekt by water";
				break;
			case MOD_SLIME:
				message = "melted";
				break;
			case MOD_LAVA:
				message = "got rekt by lava";
				break;
			case MOD_EXPLOSIVE:
			case MOD_BARREL:
				message = "got rekt by barrel";
				break;
			case MOD_EXIT:
				message = "didnt get rekt";
				break;
		...
		if (attacker == self)
		{
			switch (mod)
			{
				...
				default:
					...
					{
						message = "killed her dumb self";
					}
					else
					{
						message = "killed his dumb self";
					}
	...
	gi.bprintf(PRINT_MEDIUM, "%s got rekt.\n", self->client->pers.netname);
