...
static menuaction_s s_game_quit_action;
static menuaction_s s_game_video_action;
static menuaction_s s_game_keys_action;
static menuaction_s s_return_game_action;
...
static void
PlayerQuitFunc(void *unused)
{
          char cmd[1024];

            Com_sprintf(cmd, sizeof(cmd), "quit\n");
            Cbuf_InsertText(cmd);
}

static void
PlayerGoToVideoFunc(void *unused)
{
          char cmd[1024];

            Com_sprintf(cmd, sizeof(cmd), "menu_video\n");
            Cbuf_InsertText(cmd);
}


static void
ReturnToGameFunc(void *unused)
{
         M_ForceMenuOff();
}
...
static void
PlayerGoToKeysFunc(void *unused)
{
          char cmd[1024];

            Com_sprintf(cmd, sizeof(cmd), "menu_keys\n");
            Cbuf_InsertText(cmd);
}
...
Multiplayer_MenuInit(void)
{
    ...
    s_return_game_action.generic.type = MTYPE_ACTION;
    s_return_game_action.generic.flags = QMF_LEFT_JUSTIFY;
    s_return_game_action.generic.x = 0;
    s_return_game_action.generic.y = 10;
    s_return_game_action.generic.name = " return to game";
    s_return_game_action.generic.callback = ReturnToGameFunc;


    s_join_network_server_action.generic.type = MTYPE_ACTION;
    s_join_network_server_action.generic.flags = QMF_LEFT_JUSTIFY;
    s_join_network_server_action.generic.x = 0;
    s_join_network_server_action.generic.y = 30;
    s_join_network_server_action.generic.name = " join a game";
    ...
    s_start_network_server_action.generic.y = 40;
    s_start_network_server_action.generic.name = " create game";
    ...
    s_player_setup_action.generic.y = 50;
    s_player_setup_action.generic.name = " player setup";
    s_player_setup_action.generic.callback = PlayerSetupFunc;

    s_game_keys_action.generic.type = MTYPE_ACTION;
    s_game_keys_action.generic.flags = QMF_LEFT_JUSTIFY;
    s_game_keys_action.generic.x = 0;
    s_game_keys_action.generic.y = 70;
    s_game_keys_action.generic.name = " key bindings";
    s_game_keys_action.generic.callback = PlayerGoToKeysFunc;


    s_game_video_action.generic.type = MTYPE_ACTION;
    s_game_video_action.generic.flags = QMF_LEFT_JUSTIFY;
    s_game_video_action.generic.x = 0;
    s_game_video_action.generic.y = 80;
    s_game_video_action.generic.name = " video settings";
    s_game_video_action.generic.callback = PlayerGoToVideoFunc;

    s_game_quit_action.generic.type = MTYPE_ACTION;
    s_game_quit_action.generic.flags = QMF_LEFT_JUSTIFY;
    s_game_quit_action.generic.x = 0;
    s_game_quit_action.generic.y = 100;
    s_game_quit_action.generic.name = " quit";
    s_game_quit_action.generic.callback = PlayerQuitFunc;

Menu_AddItem(&s_multiplayer_menu, (void *)&s_return_game_action);
...
Menu_AddItem(&s_multiplayer_menu, (void *)&s_game_keys_action);
	Menu_AddItem(&s_multiplayer_menu, (void *)&s_game_video_action);

	Menu_AddItem(&s_multiplayer_menu, (void *)&s_game_quit_action);
...
KeyBindingFunc(void *self)
{
    ...
    Menu_SetStatusBar(&s_keys_menu, "press a key");
}
